...
const DBNewItems = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center pt-6 px-4 w-full md:flex-row lg:flex-wrap lg:justify-between">
      <div className="border border-gray-300 rounded-md p-4 w-full md:w-2/3 lg:w-1/2 flex flex-col items-center justify-center gap-4">
        <InputValueFiled
          type="text"
              ...
              {!imageDownloadURL ? (
                ...
                <div className="relative w-full h-full overflow-hidden rounded-md">
                  ...
                  <motion.button
                    {...buttonClick}
                    type="button"
                    className="absolute top-3 right-3 p-3 rounded-full bg-[#FEBD2E] text-xl"
        ...
        <motion.button
          ...
          {...buttonClick}
          className="w-full md:w-1/2 py-2 rounded-md bg-[#f4b221] text-primary hover:bg-[#ECAB20] cursor-pointer"
        >
          Save
        </motion.button>
      </div>
